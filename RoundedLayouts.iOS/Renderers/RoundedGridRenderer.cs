...
namespace RoundedLayouts.Renderers
{
    public class RoundedGridRenderer : ViewRenderer
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == RoundedGrid.CornerRadiusProperty.PropertyName)
            {
                NativeView.Layer.CornerRadius = ((RoundedGrid)sender).CornerRadius;
            }
            if (e.PropertyName == RoundedGrid.BorderColorProperty.PropertyName)
            {
                NativeView.Layer.BorderColor = ((RoundedGrid)sender).BorderColor.ToCGColor();
            }
            if (e.PropertyName == RoundedGrid.BorderThicknessProperty.PropertyName)
            {
                NativeView.Layer.BorderWidth = ((RoundedGrid)sender).BorderThickness;
            }
            SetNeedsDisplay();
        }
