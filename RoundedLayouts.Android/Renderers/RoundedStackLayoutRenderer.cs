    ...
    public class RoundedStackLayoutRenderer : ViewRenderer
    {
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			if (e.PropertyName == VisualElement.WidthProperty.PropertyName ||
				...
				e.PropertyName == RoundedStackLayout.CornerRadiusProperty.PropertyName ||
				e.PropertyName == RoundedStackLayout.BorderColorProperty.PropertyName ||
				e.PropertyName == RoundedStackLayout.BorderThicknessProperty.PropertyName)
			{
				this.Invalidate();
			}
		}
